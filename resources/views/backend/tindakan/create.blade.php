                        ...
                        <form action="{{ route('tindakan.store') }}" method="post">
                            ...
                            <div class="form-group mb-3 col-md-3">
                                    ...
                                    <select id="potensi" name="potensi" class="select2 form-select  @error('potensi') is-invalid @enderror">
                                        ...
                                        <option value="tinggi" {{ old('potensi') == 'tinggi' ? 'selected' : '' }} >Tinggi</option>
                                        <option value="sedang" {{ old('potensi') == 'sedang' ? 'selected' : '' }} >Sedang</option>
                                        <option value="rendah" {{ old('potensi') == 'rendah' ? 'selected' : '' }}>Rendah</option>
                                    </select>
                                    @error('potensi')
                                ...
                                <div class="form-group mb-3 col-md-9">
                                    ...
                                    <textarea type="text" class="form-control  @error('tindakan') is-invalid @enderror"
                                        name="tindakan" value="{{ old('tindakan') }}" placeholder="Masukkan Tindakan yang perlu dilakukan"></textarea>
                                    @error('tindakan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
